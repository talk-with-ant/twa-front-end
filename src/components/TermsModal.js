    ...
    return (
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <div style={{
                    height: "516px", overflow: "auto"
                }}>
                    <Modal.Body>
                        Privacy Policy
                    <br />Last updated: November 29, 2020
                    <br />
                    ...
                    <br />
                        <br />Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Talk with Ant.
                    <br />
                        <br />ookies are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.
                    <br />
                        <br />Country refers to: Thailand
                    <br />
                    ...
                    <br />
                        <br />Website refers to Talk with Ant, accessible from https://liff.line.me
                    <br />
                    ...
                    <br />Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: What Are Cookies?.
                    <br />
                    ...
                    <br />
                        <br />By email: talkwithant@gmail.com
                </Modal.Body></div>
                <Modal.Footer>
