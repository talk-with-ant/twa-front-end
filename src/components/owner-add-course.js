...
class OwnerAddCourse extends React.Component {
  ...
  componentDidMount() {
    liff
      .init({ liffId: "1655424277-grmVQB2V" })
      .then(async () => {
        if (!liff.isLoggedIn()) {
          liff.login();
        }
  ...
  handleSubmit(event) {
    ...
    axios
      .post("https://talk-with-ant-qv5fvdpzmq-de.a.run.app/api/courses", data, config)
      .then((response) => {
          ...
          <form onSubmit={this.handleSubmit} onInput={this.getProfile}>
            <div className="form-group" id="COURSE_NAME">
              ...
              <div className="form-group text-left">
                ...
                <div>
                  <input name="img" type="file" id="img" required onChange={this.handleImgChange} />
